        ...
        () => [
            ...
            },
            {
                ...
                cell: ({ getValue }) => {
                    ...
                    return subjectName ? <Badge variant="secondary">{subjectName}</Badge> : <span className="text-muted-foreground">Not set</span>
                },
            },
            {
                id: 'teacher',
                ...
                cell: ({ getValue }) => {
                    ...
                    return teacherName ? <span className="text-foreground">{teacherName}</span> : <span className="text-muted-foreground">Not assigned</span>
                },
            },
            {
                id: 'capacity',
            ...
            <div className="intro-row">
                ...
                <div className="actions-row">
                    <div className="search-field">
                        ...
                        <Input type="text" placeholder="Search by name..." className="pl-10 w-full" value={searchQuery} onChange={(event) => setSearchQuery(event.target.value)} />
                    </div>
